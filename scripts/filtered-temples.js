...
// Function to determine the largest temple image based on area
function getLargestTempleImage(templesArray) {
  return templesArray.reduce((largest, temple) => {
    return Number(temple.area) > Number(largest.area) ? temple : largest;
  }, templesArray[0]).imageUrl;
}
